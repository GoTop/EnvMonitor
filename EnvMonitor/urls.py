...
urlpatterns = patterns('',
    ...
    url(r'^report/get_abnormal_data/(?P<mn>\d{14})/(?P<date_string>\d{8})/$',
        'report.views.get_abnormal_data_view'),
    url(r'^report/count_abnormal_data/(?P<mn>\d{14})/(?P<start_date_string>\d{14})/(?P<end_date_string>\d{14})/$',
        'report.views.count_abnormal_data_view'),
    url(r'^report/count_multi_abnormal_data/(?P<start_date_string>\d{14})/(?P<end_date_string>\d{14})/$',
        'report.views.count_multi_abnormal_data_view'),
)
