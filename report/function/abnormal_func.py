...
def get_abnormal_data(mn, date):
    ...
    start_date_object = datetime.datetime.strptime(date, "%Y%m%d")

    abnormal_data_list = report_func.get_range_monitor_value(mn, start_date, end_date, param_name_list, data_type_list, type)
