...
urlpatterns = [
    ...
    # http://127.0.0.1:8000/report/45007760002007/20140101000000/20140331000000/day
    url(r'^(?P<mn>\d{14})/(?P<start_date_string>\d{14})/(?P<end_date_string>\d{14})/(?P<table_type>(day|hour))/$', views.station_data_view, name='station_data_url'),
    ...
    url(r'^count_multi_abnormal_data/(?P<start_date_string>\d{14})/(?P<end_date_string>\d{14})/(?P<table_type>(day|hour))$',
